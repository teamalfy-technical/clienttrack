...
import toogle from './images/toogleLight.png'
    ...
    return(
        <div className="bg-[#333130]">
              <nav className="border-b-2 border-[#3D3B3A]">
                 <div className="bg-[#886085] rounded-full flex justify-between p-1 md:px-4">
                    <div>
                    ...
                    <div className="flex">
                            ...
                            <Link to="/"><img className="border w-12 md:w-16 h-7 md:h-9 mt-2 md:mt-5 rounded-full" src={toogle}/></Link>
                    </div>
                </div>
            </nav>
            ...
            <section className="md:grid grid-cols-3 md:px-16">
                <div className="col-span-2 mt-5 px-4 md:px-0">
                    <h1 className="text-3xl md:text-5xl font-bold text-[#E5D5E3]">Record And Transcribe Audio <br></br> For free:</h1>
                    ...
                    className="bg-[#3D3B3A] p-3 border-2 border-[#996C95] font-semibold text-white px-10 rounded-xl text-xl">sign up now</button>
                    <button 
                    data-aos="fade-right"
                    data-aos-easing="linear"
                    data-aos-duration="3000"
                    data-aos-delay="1500"
                    className="bg-[#3D3B3A] py-3 font-semibold text-white px-4 rounded-xl ml-1"><MoveRight /></button>
                    </div>
