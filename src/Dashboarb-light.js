    ...
    return(
        <div>
            <nav className="border-b-2 border-[#3D3B3A]">
                 <div className="bg-[#3D3B3A] rounded-full flex justify-between px-4">
                <div>
            ...
            <section className="grid grid-cols-3 px-16">
                <div className="col-span-2 mt-5">
                    <h1 className="text-5xl font-bold">Record And Transcribe Audio <br></br> For free:</h1>
                    ...
                    <br></br>
                    <div className="flex">
                        <button className="bg-[#3D3B3A] p-3 font-semibold text-white px-10 rounded-xl text-xl">sign up now</button>
